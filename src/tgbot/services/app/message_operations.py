...
from src.tgbot.keyboards.inline.settings_menu import (
    information_keyboard,
)
from src.tgbot.services.app.app_scheduler import (
    send_message_week,
)
...
async def show_dating_filters(obj: CallbackQuery | Message) -> None:
